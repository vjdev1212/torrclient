...
export const StorageKeys = {
    ...
    PROWLARR_CONFIGS_KEY: 'TORRCLIENT_PROWLARR_CONFIGS_KEY',
    PROWLARR_ACTIVE_ID_KEY: 'TORRCLIENT_PROWLARR_ACTIVE_ID_KEY',
    DEFAULT_MEDIA_PLAYER_KEY: 'TORRCLIENT_DEFAULT_MEDIA_PLAYER',
    WATCH_HISTORY_KEY: 'TORRCLIENT_WATCH_HISTORY_KEY',
    RSS_FEEDS_KEY: 'TORRCLIENT_RSS_FEEDS_KEY',
} as const;
